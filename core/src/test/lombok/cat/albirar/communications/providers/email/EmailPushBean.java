...
/**
 * A bean to hold information about pushed email messages; for test purposes.
...
public class EmailPushBean extends RootPushBean {
    @Valid
    @NotNull
    @Setter(onParam_ = { @NotNull, @Valid })
    private ContactBean from;
    @Valid
    @NotNull
    @Setter(onParam_ = { @NotNull, @Valid })
    private ContactBean recipient;
    @NotBlank
