...
public class RabbitMqContainerExtension implements BeforeAllCallback, AfterAllCallback {
    ...
    public void beforeAll(ExtensionContext context) throws Exception {
        try {
            ...
            System.setProperty(IPropertiesComm.HOST_CONNECTION_PROPERTY_NAME, container.getHost());
            System.setProperty(IPropertiesComm.PORT_CONNECTION_PROPERTY_NAME, container.getAmqpPort().toString());
            System.setProperty(IPropertiesComm.USERNAME_CONNECTION_PROPERTY_NAME, container.getAdminUsername());
            System.setProperty(IPropertiesComm.PASSWORD_CONNECTION_PROPERTY_NAME, container.getAdminPassword());
