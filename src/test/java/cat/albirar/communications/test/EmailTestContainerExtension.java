...
public class EmailTestContainerExtension implements BeforeAllCallback, AfterAllCallback {
    ...
    public void beforeAll(ExtensionContext context) throws Exception {
        ...
        System.setProperty(PropertiesComm.JAVAMAIL_HOST_PROPERTY_NAME, "localhost");
        System.setProperty(PropertiesComm.JAVAMAIL_PORT_PROPERTY_NAME, Integer.valueOf(ServerSetupTest.SMTP.getPort()).toString());
        System.setProperty(PropertiesComm.JAVAMAIL_USERNAME_PROPERTY_NAME, NAME);
        System.setProperty(PropertiesComm.JAVAMAIL_PASSWORD_PROPERTY_NAME, NAME);
        System.setProperty("mail.transport.protocol", "smtp");
        ps.entrySet().forEach(entry -> System.setProperty(entry.getKey().toString(), entry.getValue().toString()));
