...
public interface IEmailProvider extends IServiceProvider {
     ...
     */
    public void sendEmail(@NotNull @Valid ContactBean from, @NotNull @Valid ContactBean recipient, @NotBlank String subject, @NotBlank String message, @NotBlank String mediaType, @NotBlank String charset);
