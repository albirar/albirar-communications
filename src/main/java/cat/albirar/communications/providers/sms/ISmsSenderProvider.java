 ...
 */
package cat.albirar.communications.providers.sms;
...
public interface ISmsSenderProvider extends IServiceProvider {
     ...
     */
    public void sendSms(@NotNull @Valid ContactBean from, @NotNull @Valid ContactBean recipient, @NotBlank String message);
}
